...
import { Music, ArrowLeft, Sparkles, Zap, Globe } from "lucide-react";
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-neutral-900/80 backdrop-blur-xl border border-neutral-800 rounded-2xl p-8 shadow-2xl">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-neutral-100 text-neutral-900 font-medium py-3.5 px-4 rounded-xl transition-all duration-200 mb-6"
          >
